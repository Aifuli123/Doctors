        ...
        public override void OnActionExecuting(HttpActionContext filterContext)
        {
            ...
            if (HttpContext.Current.Session[Keys.Uinfo] == null)
            {
                ...
                if (HttpContext.Current.Request.Cookies[Keys.IsRemember] != null)
                {
                    ...
                    Autofac.IContainer autofac = CacheMgr.GetData<Autofac.IContainer>(Keys.autofaccontainer);
                    //2.0.2.2 从autofac容器中获取IsysUserInfoServices的实现类的对象实例
                    ISysUserInfo userSer = autofac.Resolve<ISysUserInfo>();

           
                    var userinfo = userSer.GetUserById(userid);
                    ...
                    else
                    {
                        ...
                        HttpContext.Current.Session[Keys.Uinfo] = userinfo;
                    }
                }
                else
                {
